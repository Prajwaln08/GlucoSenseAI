        ...
        <ScrollView contentContainerStyle={{ padding: 24, paddingTop: 6, paddingBottom: 48 }}>
          ...
          <Card>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
              <Body style={{ fontWeight: '600' }}>Direct sensor connect</Body>
              <Pill label="Coming soon" tone="muted" />
            </View>
            <Muted style={{ marginTop: 6 }}>
              Connecting your Libre or Dexcom account directly is on the way. For now, xDRIP+ above streams the same readings.
            </Muted>
          </Card>
        </ScrollView>
      </SafeAreaView>
